...
Span::Span(const Span &copy)
    : _vector(copy._vector), _maxSize(copy._maxSize), _curSize(0) {}
...
unsigned int Span::getcurSize() { return this->_curSize; }
unsigned int Span::getmaxSize() { return this->_maxSize; }
